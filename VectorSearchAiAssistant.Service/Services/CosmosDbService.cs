...
namespace VectorSearchAiAssistant.Service.Services
{
    ...
    public class CosmosDbService : ICosmosDbService
    {
        ...
        private readonly Container _property;
            ...
            ILogger<CosmosDbService> logger)
        {
            ...
            _property = _containers["properties"];
        ...
        /// </summary>
        /// <param name="propertyname">Property item to create.</param>
        /// <returns>Newly created Property item.</returns>
        public async Task<Property> InsertPropertyAsync(Property property)
        {
            try
            {
                return await _property.CreateItemAsync(property);
            }
            catch (CosmosException ex)
            {
                ...
                {
                    _logger.LogInformation("Property already added.");
                }
                else
                {
        ...
        /// <returns></returns>
        public async Task DeletePropertyAsync(string id, string name)
        {
            try
            {
                // Delete from Cosmos Property container
                await _property.DeleteItemAsync<Property>(id: id, partitionKey: new PartitionKey(name));
            }
            catch (CosmosException ex)
            {
                if (ex.StatusCode == System.Net.HttpStatusCode.NotFound)
                {
                    _logger.LogInformation("The property has already been removed.");
                }
                else
                    throw;
            }
